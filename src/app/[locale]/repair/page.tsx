...
const Repair = async () => {
  ...
  return (
    <>
      <main className="flex w-full flex-wrap flex-col lg:flex-row lg:flex-nowrap lg:gap-4 gap-8 px-8 mt-6 mb-12 sm:mb-20">
        {/* ----------------Left side - Image-------------------- */}
        <section
      ...
      {/* Contact */}
      <div className="my-12 sm:my-20 mx-auto px-8 sm:px-28 lg:w-1/2">
